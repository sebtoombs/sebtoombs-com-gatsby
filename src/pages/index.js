...
const HomeHero = styled.div`${tw`px-10 max-w-2xl mx-auto`}`
...
const IndexPage = (props) => {
  ...
  const homePagePosts = posts.slice(0, posts.length >= 2 ? 2 : posts.length).map(p=>p.post);
    ...
    <>
      ...
      <main>
        ...
        <ContainerReading>
            ...
            <Heading size={2} as={'h2'}>I'm a web developer with a particular focus on user experience, performance, and conversion rate optimisation.</Heading>
            <Heading size={4} as={'h3'}>What do I do?</Heading>
            <P>Great question! The most general way I usually describe it is: I make websites better. This includes quite a lot of things, and of course I also make websites as well as making them better.</P>
            <Heading size={4} as={'h3'}>How do I do it?</Heading>
            <P>I work on making <i>user experiences</i>, in online &amp; digital platforms, better by taking a user-centric approach to design.</P>
            <P>A slightly less complicated way to say this might be that I try to think about what the user wants, and see how we can go about making their experience as frictionless as possible.</P>
        </ContainerReading>
